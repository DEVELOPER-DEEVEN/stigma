...
android {
    namespace = "com.stigma"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.stigma"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField(
            ...
            "\"${properties.getProperty("AZURE_OPENAI_ENDPOINT", "")}\""
        )
        buildConfigField(
            "String",
            "AZURE_OPENAI_KEY",
            "\"${properties.getProperty("AZURE_OPENAI_KEY", "")}\""
        )
        buildConfigField(
            "String",
            "AZURE_OPENAI_DEPLOYMENT",
            "\"${properties.getProperty("AZURE_OPENAI_DEPLOYMENT", "")}\""
        )
        buildConfigField(
            "String",
            "AZURE_OPENAI_API_VERSION",
            "\"${properties.getProperty("AZURE_OPENAI_API_VERSION", "")}\""
        )
    }
